                    ...
                    <div class="desc-lienhe">
                        ...
                        <ul class="margin-bottom-15 link" style="list-style-type: none;">
                            <li>
                                ...
                                <span class="title-li"> Bắc Từ Liêm, thủ đô Hà Nội</span>
                            </li>
                            <li>
                                <span class="block_fonticon"><i class="fa fa-mobile icon-lienhe"></i></span>
                                <span class="title-li">
                                        Hotline: <a style="color: #434a6e;" class="fone" href="">0868024509</a>
                            ...
                            <li>
                                ...
                                <span class="title-li">Email: <a style="color: #434a6e;"
                                                                 href="">ninhhan21@gmail.com</a></span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<script>
    $('#btnAdd').click(function(e){
        ...
        if (!json['customerPhone']) {
            $('#customerPhone').next('span').remove();
            $('#customerPhone').after('<span style="color: red">Số điện thoại không được để trống</span>');
            isValid = false;
        }
        if (isValid) {
            sendCustomer(json);
    ...
    function sendCustomer(data){
        $.ajax({
            ...
            error : function(response){
                console.log('failed');
                if (Array.isArray(response.responseJSON.messages)) {
